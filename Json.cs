    ...
    public static class Json
    {
        public static string Serialize(object value) =>
            new (Func<Type, bool> pred, Func<object, string> action)[]
            {
                ...
                (pred: t => t.IsEnum || t == typeof(char) || t == typeof(string) || t == typeof(Guid) || t == typeof(TimeSpan), action: v => v.ToString().Select(c => c == '\\' ? "\\\\" : c == '\"' ? "\\\"" : c < ' ' ? $"\\u{(int)c:x4}" : c.ToString()).Map(x => $"\"{string.Concat(x)}\"")),
